      ...
      <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
        <div className="glass-card p-6 sm:p-8 hover-lift animate-fadeInUp delay-200">
          ...
          <div className="space-y-3 sm:space-y-4">
            <a href="mailto:patwapiyush940@gmail.com" className="flex items-center gap-3 sm:gap-4 text-gray-300 hover:text-white transition-colors duration-300 group">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="font-medium text-sm sm:text-base truncate">patwapiyush940@gmail.com</p>
              </div>
            </a>

            <a href="tel:+919619825701" className="flex items-center gap-3 sm:gap-4 text-gray-300 hover:text-white transition-colors duration-300 group">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/10 rounded-full flex items-center justify-center group-hover:bg-purple-500 transition-all duration-300 flex-shrink-0">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="sm:w-6 sm:h-6">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="font-medium text-sm sm:text-base">+91 9619825701</p>
              </div>
            </a>

            <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 sm:gap-4 text-gray-300 hover:text-white transition-colors duration-300 group">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/10 rounded-full flex items-center justify-center group-hover:bg-purple-500 transition-all duration-300 flex-shrink-0">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="sm:w-6 sm:h-6">
        ...
        <div className="glass-card p-6 sm:p-8 hover-lift animate-fadeInUp delay-300">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <a href="https://github.com/piyush4806" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 group hover:scale-105">
            ...
            <a href="https://www.linkedin.com/in/piyush-patwa-21b9b6352/" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 group hover:scale-105">
            ...
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 group hover:scale-105">
            ...
            <a href="https://www.instagram.com/just_.piyush_?igsh=MWNiNTM0NXhhb2dqeA==" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 group hover:scale-105">
