          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
            <div className="flex justify-between items-center">
              ...
              <div className="hidden md:flex items-center gap-6">
                ...
                <a href="#qualifications" className="text-sm text-gray-300 hover:text-white transition-colors">Education</a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 sm:pt-32 pb-12 sm:pb-20">
          ...
          <section className="min-h-[85vh] sm:min-h-screen flex flex-col justify-center items-start mb-12 sm:mb-20">
            <div className="animate-fadeInUp delay-100">
              <p className="text-base sm:text-lg text-purple-300 mb-3 sm:mb-4">Hi there! I'm</p>
            </div>
            
            <h1 className="font-bold mb-4 sm:mb-6 animate-fadeInUp delay-200" style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: 'clamp(2.5rem, 10vw, 7rem)', lineHeight: '1.1' }}>
            ...
            <div className="animate-fadeInUp delay-300 mb-6 sm:mb-8">
              ...
              <p className="text-lg sm:text-xl text-gray-400">AI & Design Explorer</p>
            </div>
          ...
          <section id="qualifications" className="mb-20 sm:mb-32 scroll-mt-20">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              {qualifications.map((qual, i) => (
                <div key={i} className={`glass-card p-6 sm:p-8 hover-lift animate-fadeInUp delay-${(i + 2) * 100}`}>
                  <div className="text-4xl sm:text-5xl mb-3 sm:mb-4 animate-float" style={{ animationDelay: `${i * 0.3}s` }}>
                    {qual.icon}
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold mb-2 gradient-text">{qual.title}</h3>
                  <p className="text-sm sm:text-base text-gray-400">{qual.subtitle}</p>
                ...
                <div key={i} className={`glass-card p-6 sm:p-8 hover-lift animate-fadeInUp delay-${(i + 2) * 100}`}>
                  <div className="flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-white">{skill.title}</h3>
                      <p className="text-sm sm:text-base text-gray-400 leading-relaxed">{skill.desc}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <section className="mb-20 sm:mb-32 scroll-mt-20">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4">
              {hobbies.map((hobby, i) => (
                ...
                >
                  <span className="text-xl sm:text-2xl mr-2 sm:mr-3">{hobby.icon}</span>
                  <span className="text-base sm:text-lg font-medium">{hobby.name}</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <section id="projects" className="mb-20 sm:mb-32 scroll-mt-20">
            ...
            <div className="space-y-4 sm:space-y-6">
              {projects.map((project, i) => (
                <div key={i} className={`glass-card p-6 sm:p-8 md:p-10 hover-lift animate-fadeInUp delay-${(i + 2) * 100}`}>
                  <div className="flex flex-col gap-4 sm:gap-6">
                    <div className="flex-1">
                      <div className="inline-block px-3 py-1 bg-purple-500/20 rounded-full text-xs sm:text-sm text-purple-300 mb-3">
                        {project.tag}
                      </div>
                      <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 gradient-text">{project.title}</h3>
                      <p className="text-base sm:text-lg text-gray-400 leading-relaxed mb-4 sm:mb-6">{project.desc}</p>
                      <a 
                        href={project.link}
                        target="_blank"
          ...
          <section id="contact" className="mb-20 sm:mb-32 scroll-mt-20">
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="glass-card p-6 sm:p-8 hover-lift animate-fadeInUp delay-200">
                <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 gradient-text-blue">Let's Connect</h3>
                <div className="space-y-3 sm:space-y-4">
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="font-medium text-sm sm:text-base truncate">piyushpatwa@example.com</p>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="font-medium text-sm sm:text-base">Maharashtra, India</p>
                    </div>
                  </a>
                </div>
              </div>
          ...
          <section className="mb-12 sm:mb-20">
            <div className="gradient-bg p-8 sm:p-12 md:p-16 rounded-2xl sm:rounded-3xl text-center hover-lift animate-fadeInUp">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
          ...
          <footer className="py-6 sm:py-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4 text-gray-400 text-center md:text-left">
              <p className="text-sm sm:text-base">© 2026 Piyush Patwa. All rights reserved.</p>
